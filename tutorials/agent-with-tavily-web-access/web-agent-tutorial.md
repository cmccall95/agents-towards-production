  ...
  },
  {
   ...
   "outputs": [
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\cmcca\\Github\\agents-towards-production\\tutorials\\agent-with-tavily-web-access\\.venv\\Scripts\\python.exe: No module named pip\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\cmcca\\AppData\\Local\\Temp\\ipykernel_47944\\1179685388.py:8: LangGraphDeprecatedSinceV10: create_react_agent has been moved to `langchain.agents`. Please update your import to `from langchain.agents import create_agent`. Deprecated in LangGraph V1.0 to be removed in V2.0.\n",
